...
public abstract class SRegistrar {
    ...
    public abstract <R, T extends R> Supplier<T> register(Registry<R> registry, String id, Supplier<T> supplier);

    public <R, T extends R> Supplier<T> registerSimple(Registry<R> registry, String id, T value) {
    ...
    public <I extends Item> Supplier<I> item(String id, Function<Item.Settings, I> factory) {
    ...
    public Supplier<Item> simpleItem(String id, UnaryOperator<Item.Settings> factory) {
        return this.simpleItem(id, factory.apply(new Item.Settings()));
    }

    public Supplier<Item> simpleItem(String id, Item.Settings settings) {
        return this.simpleItem(id, new Item(settings));
    }

    public Supplier<Item> simpleItem(String id, Item item) {
    ...
    public <B extends Block> Supplier<B> block(String id, Function<AbstractBlock.Settings, B> factory) {
    ...
    public Supplier<Block> simpleBlock(String id, UnaryOperator<AbstractBlock.Settings> factory) {
        return this.simpleBlock(id, factory.apply(AbstractBlock.Settings.create()));
    }

    public Supplier<Block> simpleBlock(String id, AbstractBlock.Settings settings) {
        return this.simpleBlock(id, new Block(settings));
    }

    public Supplier<Block> simpleBlock(String id, Block block) {
        return this.block(id, () -> block);
    }

    // Item group

    public Supplier<ItemGroup> group(String id, Supplier<ItemGroup> supplier) {
        return this.register(Registries.ITEM_GROUP, id, supplier);
    }

    public Supplier<ItemGroup> group(String id, Text title, Supplier<ItemStack> icon, UnaryOperator<ItemGroup.Builder> factory) {
    ...
    public Supplier<ItemGroup> simpleGroup(String id, Text title, ItemConvertible icon) {
        return this.simpleGroup(id, title, new ItemStack(icon));
    }

    public Supplier<ItemGroup> simpleGroup(String id, Text title, ItemStack icon) {
        return this.simpleGroup(id, title, () -> icon);
    }

    public Supplier<ItemGroup> simpleGroup(String id, Text title, Supplier<ItemStack> icon) {
        return this.group(id, title, icon, UnaryOperator.identity());
    }

    @Deprecated
    public Supplier<ItemGroup> simpleGroup(String id, ItemGroup group) {
        return this.group(id, () -> group);
    }

    // Fluid

    public <F extends Fluid> Supplier<F> fluid(String id, Supplier<F> supplier) {
        return this.register(Registries.FLUID, id, supplier);
    }

    public <F extends Fluid> Supplier<F> simpleFluid(String id, F fluid) {
        return this.fluid(id, () -> fluid);
    }

    // Enchantment

    public <E extends Enchantment> Supplier<E> enchantment(String id, Supplier<E> supplier) {
        return this.register(Registries.ENCHANTMENT, id, supplier);
    }

    public <E extends Enchantment> Supplier<E> simpleEnchantment(String id, E enchantment) {
        return this.enchantment(id, () -> enchantment);
    }

    // Block entity type

    public <BE extends BlockEntity> Supplier<BlockEntityType<BE>> blockEntity(String id, Supplier<BlockEntityType<BE>> supplier) {
        return this.register(Registries.BLOCK_ENTITY_TYPE, id, supplier);
    }

    public <BE extends BlockEntity> Supplier<BlockEntityType<BE>> simpleBlockEntity(String id,
    ...
    public <BE extends BlockEntity> Supplier<BlockEntityType<BE>> simpleBlockEntity(String id, BlockEntityType<BE> type) {
        return this.blockEntity(id, () -> type);
    }

    // Entity type

    public <E extends Entity> Supplier<EntityType<E>> entity(String id, Supplier<EntityType<E>> supplier) {
        return this.register(Registries.ENTITY_TYPE, id, supplier);
    }

    public <E extends Entity> Supplier<EntityType<E>> simpleEntity(String id,
    ...
    public <E extends Entity> Supplier<EntityType<E>> simpleEntity(String id, EntityType<E> type) {
